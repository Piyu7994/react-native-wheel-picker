...
import type { KeyExtractor, ListMethods, OnValueChanged, OnValueChanging, PickerItem, RenderItem, RenderItemContainer, RenderList, RenderOverlay, RenderPickerItem } from "../types";
...
const defaultRenderItem: RenderItem<PickerItem<any>> = ({
  ...
  itemTextStyle
}) => <PickerItemComponent value={value} label={label} itemTextStyle={itemTextStyle} />;
...
const Picker = <ItemT extends PickerItem<any>,>({
  ...
  return <ScrollContentOffsetContext.Provider value={offsetY}>
