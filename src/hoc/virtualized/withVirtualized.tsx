...
const withVirtualized = (WrappedComponent: typeof Picker): WithVirtualizedComponent => {
  const Wrapper = <ItemT extends PickerItem<any>,>(props: WithVirtualizedProps<ItemT>) => {
